...
/**
 * Provides the local service interface for Respondida. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Francisco de Borja Segovia Gilsanz
 * @see RespondidaLocalServiceUtil
...
public interface RespondidaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RespondidaLocalServiceUtil} to access the respondida local service. Add custom service methods to {@link servicioempleodigital.service.impl.RespondidaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Respondida> getRespondidas(int start, int end);
	...
	*/
	...
	public Respondida addRespondida(Respondida respondida);
	...
	*/
	public Respondida createRespondida(RespondidaPK respondidaPK);
	...
	*/
	...
	public Respondida deleteRespondida(Respondida respondida);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Respondida deleteRespondida(RespondidaPK respondidaPK)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Respondida fetchRespondida(RespondidaPK respondidaPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Respondida getRespondida(RespondidaPK respondidaPK)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Respondida updateRespondida(Respondida respondida);
}
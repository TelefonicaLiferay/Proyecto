 ...
 * @see FooModel
 * @see servicioempleodigital.model.impl.FooImpl
 * @see servicioempleodigital.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("servicioempleodigital.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link servicioempleodigital.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

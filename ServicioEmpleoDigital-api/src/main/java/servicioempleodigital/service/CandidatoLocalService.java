...
/**
 * Provides the local service interface for Candidato. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Francisco de Borja Segovia Gilsanz
 * @see CandidatoLocalServiceUtil
...
public interface CandidatoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CandidatoLocalServiceUtil} to access the candidato local service. Add custom service methods to {@link servicioempleodigital.service.impl.CandidatoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
import servicioempleodigital.service.RespondidaService;
...
/**
 * Provides the base implementation for the respondida remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link servicioempleodigital.service.impl.RespondidaServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class RespondidaServiceBaseImpl extends BaseServiceImpl
	implements RespondidaService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link servicioempleodigital.service.RespondidaServiceUtil} to access the respondida remote service.
	 */
	 ...
	 */
	public servicioempleodigital.service.OfertaService getOfertaService() {
	 ...
	 */
	public void setOfertaService(
		servicioempleodigital.service.OfertaService ofertaService) {
	 ...
	 */
	public RespondidaService getRespondidaService() {
	 ...
	 */
	public void setRespondidaService(RespondidaService respondidaService) {
	...
	public String getOSGiServiceIdentifier() {
		return RespondidaService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = respondidaPersistence.getDataSource();
	...
	@BeanReference(type = servicioempleodigital.service.OfertaService.class)
	protected servicioempleodigital.service.OfertaService ofertaService;
	...
	@BeanReference(type = RespondidaService.class)
	protected RespondidaService respondidaService;

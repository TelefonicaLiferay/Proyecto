...
/**
 * Provides the local service interface for Resultado. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Francisco de Borja Segovia Gilsanz
 * @see ResultadoLocalServiceUtil
...
public interface ResultadoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ResultadoLocalServiceUtil} to access the resultado local service. Add custom service methods to {@link servicioempleodigital.service.impl.ResultadoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Resultado> getResultados(int start, int end);
	...
	*/
	public Resultado createResultado(ResultadoPK resultadoPK);
	...
	*/
	...
	public Resultado deleteResultado(Resultado resultado);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Resultado deleteResultado(ResultadoPK resultadoPK)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Resultado fetchResultado(ResultadoPK resultadoPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Resultado getResultado(ResultadoPK resultadoPK)
		throws PortalException;

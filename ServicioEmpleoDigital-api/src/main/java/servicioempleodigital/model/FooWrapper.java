...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<servicioempleodigital.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public int compareTo(servicioempleodigital.model.Foo foo) {
	...
	*/
	...
	@Override
	public servicioempleodigital.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public servicioempleodigital.model.Foo toUnescapedModel() {

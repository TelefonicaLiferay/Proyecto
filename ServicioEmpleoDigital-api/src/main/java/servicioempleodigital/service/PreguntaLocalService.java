...
/**
 * Provides the local service interface for Pregunta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Francisco de Borja Segovia Gilsanz
 * @see PreguntaLocalServiceUtil
...
public interface PreguntaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PreguntaLocalServiceUtil} to access the pregunta local service. Add custom service methods to {@link servicioempleodigital.service.impl.PreguntaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Pregunta> getPreguntas(int start, int end);
	...
	*/
	public Pregunta createPregunta(long idPregunta);
	...
	*/
	...
	public Pregunta deletePregunta(long idPregunta) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Pregunta deletePregunta(Pregunta pregunta);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pregunta fetchPregunta(long idPregunta);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pregunta getPregunta(long idPregunta) throws PortalException;

...
public interface RespuestaLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RespuestaLocalServiceUtil} to access the respuesta local service. Add custom service methods to {@link servicioempleodigital.service.impl.RespuestaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Respuesta createRespuesta(long idRespuesta);
	...
	*/
	...
	public Respuesta deleteRespuesta(long idRespuesta)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Respuesta fetchRespuesta(long idRespuesta);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Respuesta getRespuesta(long idRespuesta) throws PortalException;
